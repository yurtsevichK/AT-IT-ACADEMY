...
public class ExecuteTestTest {
    ...
    private final by.it.yurtsevich.homeTasks.homeTasks_day6.entity.Result expected;

    public ExecuteTestTest(Engineer engineer, int skill, by.it.yurtsevich.homeTasks.homeTasks_day6.entity.Test test, by.it.yurtsevich.homeTasks.homeTasks_day6.entity.Result expected) {
